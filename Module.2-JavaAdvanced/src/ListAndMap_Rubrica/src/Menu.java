...
public class Menu {
    ...
    /*
    Bisogna aggiustare il metodo aggCont per poter usare il metodo menu()
            ...
            switch (scelta){
                ...
                case 2:
                    try {
                        ...
                        // non avendo creato una sottoclasse di Exception, quando gestiamo l'eccesione non è palese dal nome che tipo di eccezione stiamo gestendo
                        // se vai a vedere il corpo del metodo aggiungiContatto(), vedi che lanciamo l'eccezione quando la rubrica è piena e quindi non si possono più aggiungere contatti
                ...
                case 0:
                    ...
                    return; // il return all'interno di un metodo fa uscire dal metodo stesso
            }
        }
    }
    ...
    /*
    Bisogna modificare questo metodo in modo tale che prenda più numeri di telefono per uno stesso contatto, li metta in una lista e passi la lista al metodo per aggiungere il contatto
